  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: '🔗', title: 'Launch AI Sync', desc: 'One-click sync to your Launch AI account. Leads arrive with tags, Zestimate values, cash offers, and proper routing for dialer or direct mail campaigns.' },
              ...
              { icon: '📬', title: 'Direct Mail Automation', desc: 'Automatic Zestimate and cash offer calculation for Launch AI Click2Mail campaigns. Webhook tracking for delivery and QR code scans.' },
            ].map((f) => (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border-2 border-blue-500 relative">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-1">Launch AI Sync Beta</h3>
              <div className="flex items-baseline gap-1 mb-4">
                <span className="text-4xl font-bold text-gray-900">$39</span>
                <span className="text-gray-500">/month</span>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex gap-2"><span className="text-green-500">✓</span>Connect your Launch AI system</li>
                <li className="flex gap-2"><span className="text-green-500">✓</span>Automated lead sync to Launch AI</li>
        ...
        {/* GHL Companion */}
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-2 text-center">Launch AI — Your Complete CRM</h2>
          <p className="text-gray-600 text-center mb-8 max-w-2xl mx-auto">
            Our app + Launch AI = a complete lead-to-deal system. Integrate directly with your existing Launch AI account.
          </p>
          <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 max-w-3xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
              <span className="text-2xl">📞</span>
              <div>
                <h3 className="font-bold text-gray-900">Launch AI Starter Plan</h3>
                <p className="text-sm text-gray-500">Separate subscription — you bring your own Launch AI account</p>
              </div>
            ...
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Power Dialer:</strong> Built into Launch AI — uses the voice call rates above. No additional software cost. Our app automatically tags and routes your leads so they&apos;re ready to dial the moment they hit your Launch AI pipeline.
              </p>
            </div>
          </div>
        </section>
            ...
            {[
              {
                ...
                total: '~$161',
                items: [
                  { label: 'Our App (Launch AI Sync Beta)', cost: '$39' },
                  { label: 'Launch AI Starter', cost: '$97' },
                  { label: 'Launch AI add-ons (phone, A2P)', cost: '~$15' },
              ...
              },
              {
                ...
                items: [
                  { label: 'Our App (Launch AI Sync Beta)', cost: '$39' },
                  { label: 'Launch AI Starter', cost: '$97' },
                  { label: 'Launch AI usage (calls + SMS)', cost: '~$30' },
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between bg-gray-800 rounded-lg px-4 py-2">
                    <span className="text-gray-300">Launch AI Sync Beta revenue</span>
                    <span>$39/mo</span>
                  </div>
                  <div className="flex justify-between bg-gray-800 rounded-lg px-4 py-2">
