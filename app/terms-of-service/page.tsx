          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section id="services">
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li><strong>FREE Plan:</strong> Access to property lead management with ability to purchase skip trace credits as needed</li>
            ...
            <section id="integrations">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-3">9.1 Launch AI Integration</h3>
              <p className="mb-4">
                Our Launch AI integration allows syncing of leads and automated campaigns. You are responsible
                for maintaining your Launch AI account and complying with their terms of service.
              </p>
