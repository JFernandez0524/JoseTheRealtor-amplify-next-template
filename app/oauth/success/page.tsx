...
export default function OAuthSuccessPage() {
  ...
  useEffect(() => {
    addToast({ type: 'success', title: 'Launch AI Connected!', message: 'Your Launch AI system is linked and ready to sync leads.', duration: 8000 });
    checkUserGroups();
  }, []);
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Your Launch AI system has been successfully connected.
        </p>
        ...
        {redirectUrl === '/settings' ? (
          ...
          <p className="text-sm text-gray-500 mb-8">
            You can now sync your qualified leads to Launch AI automatically.
          </p>
        )}
