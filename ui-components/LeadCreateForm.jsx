...
export default function LeadCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setStandardizedAddress(initialValues.standardizedAddress);
    setExecutorFirstName(initialValues.executorFirstName);
    setExecutorLastName(initialValues.executorLastName);
    setMailingAddress(initialValues.mailingAddress);
    setMailingCity(initialValues.mailingCity);
    setMailingState(initialValues.mailingState);
    setMailingZip(initialValues.mailingZip);
    setBorrowerFirstName(initialValues.borrowerFirstName);
    setBorrowerLastName(initialValues.borrowerLastName);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLead.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
